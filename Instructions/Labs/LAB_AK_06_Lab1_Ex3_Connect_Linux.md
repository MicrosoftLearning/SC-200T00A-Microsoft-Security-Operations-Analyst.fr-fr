...
>**Remarque :** Une **[simulation de labo interactive](https://mslabs.cloudguides.com/guides/SC-200%20Lab%20Simulation%20-%20Connect%20Linux%20hosts%20to%20Microsoft%20Sentinel%20using%20data%20connectors)** est disponible et vous permet de progresser à votre propre rythme. Il peut exister de légères différences entre la simulation interactive et le labo hébergé. Toutefois, les concepts et idées de base présentés sont identiques.
...
1. Dans la page de solution *Common Event Format*, sélectionnez **Installer**.
...
1. Sélectionnez le connecteur de données *CEF (Common Events Format),* puis **Ouvrir la page du connecteur** dans le panneau d’informations du connecteur.
...
1. Entrez la commande PowerShell suivante, en l’adaptant aux informations spécifiques de votre serveur Linux, puis appuyez sur Entrée :
...
1. Dans la page de la solution *Syslog*, sélectionnez **Installer**.
